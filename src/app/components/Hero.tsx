      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-blue-600 text-white px-6 sm:px-8 py-3 rounded-full hover:bg-blue-700">
              Explore Agents
            </button>
            <button className="border-2 border-blue-600 text-blue-600 px-6 sm:px-8 py-3 rounded-full hover:bg-blue-50">
              Learn More
            </button>
          </div>
        </div>
